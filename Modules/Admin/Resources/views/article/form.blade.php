    ...
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="content" cols="30" rows="3" placeholder="Mô tả ngắn sản phẩm" name="a_content">{{ old('a_content',isset($article->a_content) ? $article->a_content : '') }}</textarea>
