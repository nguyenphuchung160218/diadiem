...
<head>
    ...
    <title>Địa Điểm Tây Nguyên - Trang quản lý</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.home') }}">Địa Điểm Tây Nguyên</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="{{ \Request::route()->getName() == 'admin.list.area' ? 'active' : '' }}">
                        <a href="{{ route('admin.list.area') }}"><i class="fa fa-fw fa-bar-chart-o"></i> Khu Vực</a>
                    </li>     
                    <li class="{{ \Request::route()->getName() == 'admin.list.store' ? 'active' : '' }}">
                        <a href="{{ route('admin.list.store') }}"><i class="fa fa-fw fa-bar-chart-o"></i> Quán</a>
                    </li>                          
